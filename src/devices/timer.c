...
timer_init (void)
{
  ...
  list_init (&list_sleeping_threads);
}
...
//If first parameter has sleep time less than that of the second, returns true, otherwise false
//Used to insert threads into list by sorting them in ascending order of breask_sleep time
